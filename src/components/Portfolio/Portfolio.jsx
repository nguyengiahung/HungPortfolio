      ...
      <div className="container">
        ...
        <div className="portfolio__list">
          <div className="portfolio__item row align-items-center">
            <div className="portfolio__img col-12 col-sm-6">
              <img src={elearningpic} alt="" />
            </div>
            <div className="portfolio__info text-center col-12 col-sm-6 mt-4 mt-sm-0">
              <div className="d-flex align-items-center justify-content-center">
                <h3 className="section__subtitle mb-0 mr-2">ELEARNING CYBERSOFT</h3>
                <img src={courseicon} alt="" />
              </div>
              <p className="portfolio__desc my-1 mt-lg-4">
                The website describes the learning system including how features
                such as Register, Login, Search, Filter, Sign Up for Courses.
              </p>
              <div className="portfolio__languages my-3 mt-lg-4 mb-lg-5 d-flex justify-content-center">
                <span>React</span>
                <span>SCSS</span>
                <span>Antd Design</span>
              </div>
              <div className="portfolio__action d-flex justify-content-center gap-5">
                <a href="https://github.com/nhuminh24122000/Elearning_Capstone_Group1" className="d-flex align-items-center">
                  <span>Code</span>
                  <i class="bx bxl-github"></i>
                </a>
                <a href="https://elearning-capstone-group1.vercel.app/" className="d-flex align-items-center">
                  <span>Live Demo</span>
          ...
          <div className="portfolio__item row align-items-center">
            ...
            <div className="portfolio__info text-center col-12 col-sm-6 mt-4 mt-sm-0">
              <div className="d-flex align-items-center justify-content-center">
                <h3 className="section__subtitle mb-0 mr-2">SHOE SHOP</h3>
              ...
              <div className="portfolio__action d-flex justify-content-center gap-5">
                <a href="https://github.com/nhuminh24122000/Capstone_Group1_Buoi45" className="d-flex align-items-center">
                  <span>Code</span>
                  <i class="bx bxl-github"></i>
                </a>
                <a href="https://capstone-group1-buoi45.vercel.app/" className="d-flex align-items-center">
                  <span>Live Demo</span>
                  <i class="bx bx-chevrons-right arrow-right"></i>
                </a>
              </div>
          ...
          <div className="portfolio__item row align-items-center">
            ...
            <div className="portfolio__info text-center col-12 col-sm-6 mt-4 mt-sm-0">
              <div className="d-flex align-items-center justify-content-center">
                <h3 className="section__subtitle mb-0 mr-2">PORTFOLIO</h3>
